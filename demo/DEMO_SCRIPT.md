...
| 6 | 2:00–2:25 | Ops: burst (6 rapid attempts) → tripwire → Investigate | "Coordinated attack pattern — the deterministic tripwire fires, and the AI agent investigates through its PII-sealed tool belt: re-queries telecom signals, clusters the cohort, drafts the bilingual report. The AI never decides — it documents." |
